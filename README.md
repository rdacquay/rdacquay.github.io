...
<div>
    ...
    <input id="udataUrl" name="udataUrl" required type="text" value=""/>
</div>
<div>
    <label>webAppUrl</label>
    <input id="webAppUrl" name="webAppUrl" required type="text" value=""/>
</div>
<div>
    <label>appId</label>
    <input id="appId" name="appId" required type="text" value=""/>
</div>
<div>
    <label>apiKey</label>
